...
int main() {
	...
	FILE *f_equalized_PDF_YUV = fopen("/Users/yeahna/Documents/EWHA/18-1/SmartSoftwareProject/opencv_practice_week3/opencv_practice_week3/equalized_PDF_YUV.txt", "w+");
    FILE *f_PDF_RGB = fopen("/Users/yeahna/Documents/EWHA/18-1/SmartSoftwareProject/opencv_practice_week3/opencv_practice_week3/PDF_RGB_YUV.txt", "w+");
	FILE *f_trans_func_eq_YUV = fopen("/Users/yeahna/Documents/EWHA/18-1/SmartSoftwareProject/opencv_practice_week3/opencv_practice_week3/trans_func_eq_YUV.txt", "w+");
	...
	for (int i = 0; i < L; i++) {
        ...
        fprintf(f_equalized_PDF_YUV, "%d\t%f", i, equalized_PDF_YUV[i][0]);
        fprintf(f_equalized_PDF_YUV, "%d\t%f", i, equalized_PDF_YUV[i][1]);
