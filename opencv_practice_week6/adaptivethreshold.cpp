...
int main() {
	...
	Mat input = imread("/Users/yeahna/Documents/EWHA/18-1/SmartSoftwareProject/Week6/opencv_practice_week6/opencv_practice_week6/writing.jpg", CV_LOAD_IMAGE_COLOR);
	Mat input_gray;
	Mat output;
