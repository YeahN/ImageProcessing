...
int main() {
	...
	Mat input = imread("/Users/yeahna/Documents/EWHA/18-1/SmartSoftwareProject/Week7/opencv_practice_week7/opencv_practice_week7/lena.jpg", CV_LOAD_IMAGE_COLOR);
...
//	input_gray.convertTo(input_gray, CV_64F, 1.0 / 255);	// 8-bit unsigned char -> 64-bit floating point
    ...
    cv::Canny(input_gray, output, 100, 50);
